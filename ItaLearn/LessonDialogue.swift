...
nonisolated enum LessonDialogue {
    ...
    /// The model often approximates Italian guillemets with ASCII angle brackets.
    ...
    static func colors(for lines: [Line]) -> [String: Color] {
        let palette = [ItaLearn.purple, ItaLearn.magenta, ItaLearn.cyan, ItaLearn.deepGreen]
...
struct LessonDialogueView: View {
    ...
    private func turn(speaker: String, text: String) -> some View {
        let tint = speaker.isEmpty ? ItaLearn.purple : (colors[speaker] ?? ItaLearn.purple)
