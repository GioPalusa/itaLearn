...
/// Reads Italian aloud with the best installed Italian voice.
@MainActor
final class SpeechNarrator: NSObject, AVSpeechSynthesizerDelegate {
    ...
    /// Prefer a premium or enhanced Italian voice when the user has downloaded one.
    private static let italianVoice: AVSpeechSynthesisVoice? = {
