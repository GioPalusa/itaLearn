...
struct HomeView: View {
        ...
        HStack(alignment: .bottom, spacing: 12) {
            ...
            Button {
                ...
                Text(settings.initials)
                    ...
                    .background(LangLearn.brandGradient, in: .circle)
            }
            .buttonStyle(.plain)
    ...
    private var heroCard: some View {
        ...
        .padding(18)
        .frame(maxWidth: .infinity, alignment: .leading)
        .background(LangLearn.brandGradient, in: .rect(cornerRadius: LangLearn.cardRadius))
    ...
    private var widgetCard: some View {
        Button {
            ...
            HStack(spacing: 12) {
                ...
                .background(LangLearn.canvas, in: .rect(cornerRadius: 14))
                .overlay {
...
private struct WordCard: View {
    ...
    private static let palette: [(Color, Color)] = [
        ...
        (Color(red: 0xC7 / 255, green: 0xD9 / 255, blue: 0xF2 / 255), LangLearn.cyan),
        (Color(red: 0xE8 / 255, green: 0xC5 / 255, blue: 0xDD / 255), LangLearn.magenta)
    ]
