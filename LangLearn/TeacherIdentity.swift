...
nonisolated enum TeacherIdentity {
    ...
    static func instruction(for course: LanguageCourse) -> String { """
    You are Milo, LangLearn's friendly animated \(course.targetName) teacher, represented by Snow's stylized look:
