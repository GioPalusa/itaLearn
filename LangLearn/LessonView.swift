...
struct LessonView: View {
            ...
            if !latestFocusAreas.isEmpty {
                ...
                HStack(alignment: .top, spacing: 8) {
                    Image(systemName: "arrow.triangle.branch")
                        .font(.system(size: 15))
                        .foregroundStyle(LangLearn.cyan)
                        .padding(.top, 2)
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("Din lärare håller extra utkik efter det här — det var dina nästa steg förra gången.")
                            .font(.il(14))
                            .foregroundStyle(LangLearn.inkSecondary)
                        FeedbackList(items: latestFocusAreas, color: LangLearn.cyan)
                    }
                }
            }
        }
    ...
    private var writingCard: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            .buttonStyle(
                LangLearnPrimaryButtonStyle(
                    background: AnyShapeStyle(LangLearn.purple),
    ...
    private var modelStatus: some View {
        statusLine(
            ...
            systemImage: "network", tint: LangLearn.inkTertiary
        )
    }
    ...
    private func correctionCard(_ feedback: LessonFeedback) -> some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            if !feedback.ruleTitle.isEmpty {
                ...
                .frame(maxWidth: .infinity, alignment: .leading)
                .padding(12)
                .background(LangLearn.field, in: .rect(cornerRadius: 12))
            }
    ...
    private func summaryCard(_ feedback: LessonFeedback) -> some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                Label {
                    ...
                    Image(systemName: "heart.fill")
                        .font(.system(size: 14))
                        .foregroundStyle(LangLearn.green)
                }
                FeedbackList(items: feedback.strengths, color: LangLearn.green)
            }
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                FeedbackList(items: feedback.nextSteps, color: LangLearn.magenta)
            }
...
private struct ThinkingCard: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(spacing: 8) {
                shimmerBar(tint: LangLearn.magenta, widthFactor: 1, delay: 0)
                shimmerBar(tint: LangLearn.cyan, widthFactor: 0.78, delay: 0.2)
                shimmerBar(tint: LangLearn.purple, widthFactor: 0.54, delay: 0.4)
            }
        }
        .langlearnCard()
